...
@CmdDefine(command = "group", alias = "groupperm", allowConsole = true, subCommands = {"\\S+", "addperm|setperm|aperm|sp", "\\S+"}, permission = "multipass.admin", description = Message.CMD_GROUP_SETPERM)
